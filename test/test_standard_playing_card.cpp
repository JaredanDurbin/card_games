...
#include "../header/StandardPlayingCard.hpp"
// ----------------------------------------------------------------------------
...
int main()
{
   ...
   StandardPlayingCard card1(11,"spade");
   ...
   StandardPlayingCard card2(card1);
   // Print the card data: rank and suit.
   ...
   StandardPlayingCard card3(1324,"dsaf");
   std::cout << "Card3: " << card3.GetRank() << " of " 
             << card3.GetSuit() << "s.\n";
